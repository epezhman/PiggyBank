...
/*                    else if(e.value.length >= 10 && e.value.match("^[a-zA-Z0-9]+$")){
                    ...
                    else if(e.value.length >= 10 && e.value.match("(?=^.{10,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$")){
                        $('#'+e.id+'span').css("background","#00CC00");
        ...
        -->
                <div class="col-sm-12">
                    <div style="padding-top:40px;">
                        <form class="form-signup" role="form" action="f8d890ce88bd1791b6eaddf06e58ceb5/registeremployee.php" method="POST" onsubmit="handleSecrets(this)">
                            <table width=700px>
                            <tr><td>
