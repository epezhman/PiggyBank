...
//			accountField.setText("PB37083707");
			...
			PINField.setMaximumSize(new Dimension(570, 30));
			amountField.setMaximumSize(new Dimension(570, 30));
			accountField.setMaximumSize(new Dimension(570, 30));
			OTPText.setMaximumSize(new Dimension(570, 30));
