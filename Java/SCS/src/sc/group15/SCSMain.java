...
//			accountField.setText("PB37083707");
			...
			PINField.setMaximumSize(new Dimension(550, 30));
			amountField.setMaximumSize(new Dimension(550, 30));
			accountField.setMaximumSize(new Dimension(550, 30));
			OTPText.setMaximumSize(new Dimension(550, 30));
