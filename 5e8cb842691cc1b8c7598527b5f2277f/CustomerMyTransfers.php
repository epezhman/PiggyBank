							...
							<tbody>
								...
								try{
									...
									while($transfers->fetch())
									{
										...
										$customerFullName = $dbConnection->prepare("SELECT customerName FROM Customer INNER JOIN Account WHERE Customer.customerID = Account.accountOwner AND Account.accountNumber LIKE (?)");
